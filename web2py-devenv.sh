...
echo "4) Create a public git repo on github or bitbucket and push it."
echo "5) Web2py must execute your application from src/"
echo ""
echo "Go ahead! Start coding for your new project."
echo ""
